...
function AuthSection() {
  return (
    <section className="auth-section">
      ...
      <h2 className='auth-section-title'>Join us and enjoy more benefits!</h2>
      ...
      <img src={Personas} alt="People enjoying shopping together" loading="lazy" className='auth-image'/>
      </div>
    </section>
  );
}
