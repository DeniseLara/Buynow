  ...
  return (
    <section className="footer-content-principal">
        ...
        <article className="footer-links">
          ...
          <ul>
          <li><Link to="" aria-label="About us page">About Us</Link></li>
              <li><Link to="" aria-label="Terms and conditions page">Terms and Conditions</Link></li>
              <li><Link to="" aria-label="Privacy policy page">Privacy Policy</Link></li>
              <li><Link to="" aria-label="Frequently asked questions page">Frequently Asked Questions</Link></li>
          </ul>
        </article>
