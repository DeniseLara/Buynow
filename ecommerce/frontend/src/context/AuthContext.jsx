...
import { getUserProfile, registerUser, loginUser, logoutUser, updateUserData } from '../services/authService'
...
export const AuthProvider = ({ children }) => {
  ...
  const updateProfile = async (updates) => {
    try {
      await updateUserData(user.uid, updates); // Tu servicio de Firebase
